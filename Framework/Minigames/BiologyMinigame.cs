			...
			OnClick = (args) =>
{
	...
	else if (x == 1)
	{
		...
		z = "";
		a = "Game Over!";
		SoundService.PlaySound("minigame_assets/Biology_assets/SpongeBob sad music.m4a");
	...
	else if (y == 4)
	{
		...
		z = "";
		a = "You win!";
		SoundService.PlaySound("minigame_assets/Biology_assets/Yippee - Meme Sound Effect.m4a");
		GameState.SetState("Bio-Game.Complete", true);
